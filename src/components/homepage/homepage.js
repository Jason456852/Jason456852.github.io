import { Grid, Card, CardHeader, CardMedia, CardContent, CardActions, Collapse, IconButton, Typography } from "@mui/material";
                ...
                <Grid item xs={6}>
                    <Card sx={{ maxWidth: 450, margin: "0 auto", marginY: 5 }}>
                        ...
                        <CardActions disableSpacing>
                            <ExpandMore expand={expanded[index]} onClick={() => handleExpandClick(index)} aria-expanded={expanded[index]}>
                                <ExpandMoreIcon />
                            </ExpandMore>
                        </CardActions>
...
const cardDetails = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            "With a keen eye for detail and a commitment to continuous improvement, I consistently seek innovative ways to refine and optimize steps and processes. My goal is to foster an environment where every task is not just completed but done so with grace, speed, and precision. I am driven by the belief that technology can be harnessed to simplify, enhance, and elevate our daily routines.",
            "Whether it's optimizing workflows, enhancing user experiences, or simplifying complex systems, I revel in the challenge of turning intricate problems into elegantly simple solutions. I am excited to bring my expertise in automation, coding, and process improvement to contribute to your projects and help you achieve your goals."
        ]
    },
    {
